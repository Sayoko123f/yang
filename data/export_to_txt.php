<?php
require_once('kmdn.php');

$d = array(
    "2020/07", "2020/06", "2020/05", "2020/04", "2020/03", "2020/02", "2020/01",
...
foreach ($kmdn as $v) {
    ...
    $txt = fopen("{$path}/{$v['id']}_.txt","w");
    fwrite($txt,dealTxtContent($v["content"]));
    fclose($txt);
    
}

function dealTxtContent($content){
